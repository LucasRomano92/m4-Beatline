...
const productsToPreLoad: IProduct[] = [
  {
    ...
    price: 699,
    description:
      "Experience power and elegance with the LUCAS BATERIA: capture stunning moments with its dual-camera system, enjoy exceptional performance, and immerse yourself in a brilliant Liquid Retina display. Discover a world of possibilities in the palm of your hand!",
    image:
